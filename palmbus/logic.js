                                            ...
                                            <div class="options-scroll-area">
                                                <div class="options custom-scrollbar">
                                                    <span class="parc-badge">
                                                        ...
                                                        <span class="parc-number">${(vehicle.vehicle.label.replace("TCAR:Vehicle::", "").replace(":LOC", "") || vehicle.vehicle.id.replace("TCAR:Vehicle::", "").replace(":LOC", "") || t("unknownparc")).toString().padStart(3, '0')}</span>
                                                        <span class="parc-number-hidden">${(vehicle.vehicle.label.replace("TCAR:Vehicle::", "").replace(":LOC", "") || vehicle.vehicle.id.replace("TCAR:Vehicle::", "").replace(":LOC", "") || t("unknownparc"))}</span>
                                                    </span>
